...
import static io.opentelemetry.contrib.inferredspans.collections.CollectionUtil.findNextPositivePowerOfTwo;
import static io.opentelemetry.contrib.inferredspans.collections.CollectionUtil.validateLoadFactor;
 ...
 */
@SuppressWarnings({"serial", "rawtypes", "NullAway", "BooleanParameter"})
