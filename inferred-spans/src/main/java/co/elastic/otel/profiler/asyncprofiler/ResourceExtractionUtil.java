...
public class ResourceExtractionUtil {
  ...
  /**
   * Extracts a classpath resource to {@code
   * ${System.getProperty("java.io.tmpdir")}/$prefix-$hash.$suffix}. If the file has already been
   * extracted it will not be extracted again.
   *
   ...
   */
  public static synchronized Path extractResourceToTempDirectory(
      String resource, String prefix, String suffix) {
    return extractResourceToDirectory(
        resource, prefix, suffix, Paths.get(System.getProperty("java.io.tmpdir")));
  }
