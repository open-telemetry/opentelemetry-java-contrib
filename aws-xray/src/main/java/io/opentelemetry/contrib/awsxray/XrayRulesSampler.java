...
final class XrayRulesSampler implements Sampler {
  ...
  private XrayRulesSampler(
    ...
    if (this.adaptiveSamplingConfig != null
      ...
      int defaultAnomalyTracesPerSecond = 1;
      AwsXrayAdaptiveSamplingConfig.AnomalyCaptureLimit defaultLimit =
          AwsXrayAdaptiveSamplingConfig.AnomalyCaptureLimit.builder()
              .setAnomalyTracesPerSecond(defaultAnomalyTracesPerSecond)
              .build();
      this.adaptiveSamplingConfig =
          this.adaptiveSamplingConfig.toBuilder().setAnomalyCaptureLimit(defaultLimit).build();
      this.anomalyCaptureRateLimiter =
          new RateLimiter(defaultAnomalyTracesPerSecond, defaultAnomalyTracesPerSecond, clock);
