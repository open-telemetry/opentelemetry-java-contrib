...
[![Maven](https://img.shields.io/maven-central/v/io.opentelemetry.contrib/opentelemetry-jmx-scraper?label=Maven&color=orange)](https://central.sonatype.com/artifact/io.opentelemetry.contrib/opentelemetry-jmx-scraper)
...
| `experimental-cassandra`     | Apache Cassandra      |                                                                 | [`experimental-cassandra.yaml`](https://github.com/open-telemetry/opentelemetry-java-instrumentation/blob/main/instrumentation/jmx-metrics/library/src/main/resources/jmx/rules/experimental-cassandra.yaml) ([doc](https://github.com/open-telemetry/opentelemetry-java-instrumentation/blob/main/instrumentation/jmx-metrics/library/cassandra.md))             |
...
| `experimental-kafka-connect` | Kafka Connect         |                                                                 | [`experimental-kafka-connect.yaml`](https://github.com/open-telemetry/opentelemetry-java-instrumentation/blob/main/instrumentation/jmx-metrics/library/src/main/resources/jmx/rules/experimental-kafka-connect.yaml) ([doc](https://github.com/open-telemetry/opentelemetry-java-instrumentation/blob/main/instrumentation/jmx-metrics/library/kafka-connect.md)) |
