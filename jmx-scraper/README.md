...
| `kafka-connect`          | Kafka Connect         |                                                                 | [`experimental-kafka-connect.yaml`](https://github.com/open-telemetry/opentelemetry-java-instrumentation/blob/main/instrumentation/jmx-metrics/library/src/main/resources/jmx/rules/experimental-kafka-connect.yaml)                                                                                                                  |
