 ...
 * </ul>
 *
 * <p>Both metrics carry {@code taskType}, {@code keyspace}, and {@code columnfamily} attributes.
 * Entries missing any of these dimension fields are skipped. Byte values are string-encoded in the
 * MBean and parsed via {@link BigInteger}.
 *
...
public final class CassandraCompactionProgressHandler implements ExperimentalJmxMetricHandler {
  ...
  private static Attributes buildAttributes(String taskType, String keyspace, String columnFamily) {
    ...
    builder.put("taskType", taskType);
    builder.put("keyspace", keyspace);
    builder.put("columnfamily", columnFamily);
