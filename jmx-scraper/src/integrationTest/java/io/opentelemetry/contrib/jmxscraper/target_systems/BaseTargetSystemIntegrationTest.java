...
public abstract class BaseTargetSystemIntegrationTest {
  private static final Logger logger =
      LoggerFactory.getLogger(BaseTargetSystemIntegrationTest.class);
  ...
  protected static OtlpGrpcServer otlpServer;
  ...
  protected void startContainers(Path tmpDir) {
    ...
    scraper =
        new JmxScraperContainer(otlpEndpoint, scraperBaseImage())
            ...
            // continue testing metrics defined in this project.
  ...
  protected static class OtlpGrpcServer extends ServerExtension {

    private final BlockingQueue<ExportMetricsServiceRequest> metricRequests =
        new LinkedBlockingDeque<>();

    public List<ExportMetricsServiceRequest> getMetrics() {
