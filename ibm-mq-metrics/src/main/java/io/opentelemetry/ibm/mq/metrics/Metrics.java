...
private Metrics(){
  ...
  public static LongGauge createIbmMqReusableLogSize(Meter meter) {
    return meter
        ...
        .ofLongs()
        .setUnit("By")
        .setDescription("The amount of space occupied, in megabytes, by log extents available to be reused.")
        .build();
  }
  ...
  public static LongGauge createIbmMqOnqtimeShortPeriod(Meter meter) {
    return meter
        ...
        .ofLongs()
        .setUnit("microseconds")
        .setDescription("Amount of time, in microseconds, that a message spent on the queue, over a short period")
        .build();
  }
  ...
  public static LongGauge createIbmMqOnqtimeLongPeriod(Meter meter) {
    return meter
        ...
        .ofLongs()
        .setUnit("microseconds")
        .setDescription("Amount of time, in microseconds, that a message spent on the queue, over a longer period")
        .build();
  }
