...
package io.opentelemetry.contrib.jfr.streaming.internal.network;

import static io.opentelemetry.contrib.jfr.streaming.internal.Constants.ATTR_NETWORK_MODE;
...
import static io.opentelemetry.contrib.jfr.streaming.internal.Constants.METRIC_DESCRIPTION_NETWORK_BYTES;
import static io.opentelemetry.contrib.jfr.streaming.internal.Constants.METRIC_DESCRIPTION_NETWORK_DURATION;
import static io.opentelemetry.contrib.jfr.streaming.internal.Constants.METRIC_NAME_NETWORK_BYTES;
import static io.opentelemetry.contrib.jfr.streaming.internal.Constants.METRIC_NAME_NETWORK_DURATION;
import static io.opentelemetry.contrib.jfr.streaming.internal.Constants.MILLISECONDS;
import static io.opentelemetry.contrib.jfr.streaming.internal.Constants.NETWORK_MODE_WRITE;
